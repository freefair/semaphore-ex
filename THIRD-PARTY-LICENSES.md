...
| `github.com/containerd/errdefs` | v1.0.0 | Apache-2.0 | [link](https://github.com/containerd/errdefs/blob/v1.0.0/LICENSE) |
| `github.com/containerd/errdefs/pkg` | v0.3.0 | Apache-2.0 | [link](https://github.com/containerd/errdefs/blob/pkg/v0.3.0/pkg/LICENSE) |
...
| `github.com/davecgh/go-spew` | v1.1.2-0.20180830191138-d8f796af33cc | ISC | [link](https://github.com/davecgh/go-spew/blob/d8f796af33cc/LICENSE) |
| `github.com/distribution/reference` | v0.6.0 | Apache-2.0 | [link](https://github.com/distribution/reference/blob/v0.6.0/LICENSE) |
| `github.com/docker/go-connections` | v0.7.0 | Apache-2.0 | [link](https://github.com/docker/go-connections/blob/v0.7.0/LICENSE) |
| `github.com/docker/go-units` | v0.5.0 | Apache-2.0 | [link](https://github.com/docker/go-units/blob/v0.5.0/LICENSE) |
| `github.com/dustin/go-humanize` | v1.0.1 | MIT | [link](https://github.com/dustin/go-humanize/blob/v1.0.1/LICENSE) |
| `github.com/emicklei/go-restful/v3` | v3.13.0 | MIT | [link](https://github.com/emicklei/go-restful/blob/v3.13.0/LICENSE) |
...
| `github.com/fxamacker/cbor/v2` | v2.9.1 | MIT | [link](https://github.com/fxamacker/cbor/blob/v2.9.1/LICENSE) |
...
| `github.com/go-openapi/jsonpointer` | v1.0.0 | Apache-2.0 | [link](https://github.com/go-openapi/jsonpointer/blob/v1.0.0/LICENSE) |
| `github.com/go-openapi/jsonreference` | v1.0.0 | Apache-2.0 | [link](https://github.com/go-openapi/jsonreference/blob/v1.0.0/LICENSE) |
| `github.com/go-openapi/swag` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/v0.27.1/LICENSE) |
| `github.com/go-openapi/swag/cmdutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/cmdutils/v0.27.1/cmdutils/LICENSE) |
| `github.com/go-openapi/swag/conv` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/conv/v0.27.1/conv/LICENSE) |
| `github.com/go-openapi/swag/fileutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/fileutils/v0.27.1/fileutils/LICENSE) |
| `github.com/go-openapi/swag/jsonutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/jsonutils/v0.27.1/jsonutils/LICENSE) |
| `github.com/go-openapi/swag/loading` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/loading/v0.27.1/loading/LICENSE) |
| `github.com/go-openapi/swag/mangling` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/mangling/v0.27.1/mangling/LICENSE) |
| `github.com/go-openapi/swag/netutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/netutils/v0.27.1/netutils/LICENSE) |
| `github.com/go-openapi/swag/pools` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/pools/v0.27.1/pools/LICENSE) |
| `github.com/go-openapi/swag/stringutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/stringutils/v0.27.1/stringutils/LICENSE) |
| `github.com/go-openapi/swag/typeutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/typeutils/v0.27.1/typeutils/LICENSE) |
| `github.com/go-openapi/swag/yamlutils` | v0.27.1 | Apache-2.0 | [link](https://github.com/go-openapi/swag/blob/yamlutils/v0.27.1/yamlutils/LICENSE) |
...
| `github.com/google/gnostic-models` | v0.7.0 | Apache-2.0 | [link](https://github.com/google/gnostic-models/blob/v0.7.0/LICENSE) |
...
| `github.com/json-iterator/go` | v1.1.12 | MIT | [link](https://github.com/json-iterator/go/blob/v1.1.12/LICENSE) |
...
| `github.com/moby/docker-image-spec` | v1.3.1 | Apache-2.0 | [link](https://github.com/moby/docker-image-spec/blob/v1.3.1/LICENSE) |
| `github.com/moby/moby/api` | v1.55.0 | Apache-2.0 | [link](https://github.com/moby/moby/blob/api/v1.55.0/api/LICENSE) |
| `github.com/moby/moby/client` | v0.5.1 | Apache-2.0 | [link](https://github.com/moby/moby/blob/client/v0.5.1/client/LICENSE) |
| `github.com/modern-go/concurrent` | v0.0.0-20180306012644-bacd9c7ef1dd | Apache-2.0 | [link](https://github.com/modern-go/concurrent/blob/bacd9c7ef1dd/LICENSE) |
| `github.com/modern-go/reflect2` | v1.0.3-0.20250322232337-35a7c28c31ee | Apache-2.0 | [link](https://github.com/modern-go/reflect2/blob/35a7c28c31ee/LICENSE) |
...
| `github.com/opencontainers/go-digest` | v1.0.0 | Apache-2.0 | [link](https://github.com/opencontainers/go-digest/blob/v1.0.0/LICENSE) |
| `github.com/opencontainers/image-spec` | v1.1.1 | Apache-2.0 | [link](https://github.com/opencontainers/image-spec/blob/v1.1.1/LICENSE) |
...
| `github.com/redis/go-redis/v9` | v9.22.0 | BSD-2-Clause | [link](https://github.com/redis/go-redis/blob/v9.22.0/LICENSE) |
...
| `github.com/x448/float16` | v0.8.4 | MIT | [link](https://github.com/x448/float16/blob/v0.8.4/LICENSE) |
| `github.com/xanzy/ssh-agent` | v0.3.3 | Apache-2.0 | [link](https://github.com/xanzy/ssh-agent/blob/v0.3.3/LICENSE) |
| `go.opentelemetry.io/auto/sdk` | v1.1.0 | Apache-2.0 | [link](https://github.com/open-telemetry/opentelemetry-go-instrumentation/blob/sdk/v1.1.0/sdk/LICENSE) |
| `go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp` | v0.60.0 | Apache-2.0 | [link](https://github.com/open-telemetry/opentelemetry-go-contrib/blob/instrumentation/net/http/otelhttp/v0.60.0/instrumentation/net/http/otelhttp/LICENSE) |
| `go.opentelemetry.io/otel` | v1.35.0 | Apache-2.0 | [link](https://github.com/open-telemetry/opentelemetry-go/blob/v1.35.0/LICENSE) |
...
| `k8s.io/api` | v0.37.0 | Apache-2.0 | [link](https://github.com/kubernetes/api/blob/v0.37.0/LICENSE) |
| `k8s.io/apimachinery` | v0.37.0 | Apache-2.0 | [link](https://github.com/kubernetes/apimachinery/blob/v0.37.0/LICENSE) |
| `k8s.io/client-go` | v0.37.0 | Apache-2.0 | [link](https://github.com/kubernetes/client-go/blob/v0.37.0/LICENSE) |
...
| `sigs.k8s.io/yaml` | v1.6.0 | Apache-2.0 | [link](https://github.com/kubernetes-sigs/yaml/blob/v1.6.0/LICENSE) |
...
| `nanoid` | 3.3.19 | MIT | [link](https://github.com/ai/nanoid) |
| `picocolors` | 1.1.1 | ISC | [link](https://github.com/alexeyraspopov/picocolors) |
| `postcss` | 8.5.28 | MIT | [link](https://github.com/postcss/postcss) |
