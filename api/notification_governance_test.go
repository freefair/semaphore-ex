...
func TestNotificationGovernanceRouterEnforcesGlobalAndProjectPermissions(t *testing.T) {
	...
	router := Route(store, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, notificationGovernanceLogWriter{}, nil, metrics.NewMetrics(), nil, nil, &notificationGovernanceStub{err: pro_interfaces.ErrNotificationUnavailable})
