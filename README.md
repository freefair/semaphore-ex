...
- **Remote runner image**: `ghcr.io/freefair/semaphore-ex-runner`, configured as described in the
  [runner guide](https://github.com/freefair/semaphore-ex/wiki/Runners).
...
under [implementation slices](https://github.com/freefair/semaphore-ex/wiki/Implementation-Slices).
...
- [Complete configuration reference](https://github.com/freefair/semaphore-ex/wiki/Configuration-Reference) and
  [additional schemas](https://github.com/freefair/semaphore-ex/wiki/Configuration-Schemas)
