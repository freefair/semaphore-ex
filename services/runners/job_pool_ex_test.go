...
func (*kubernetesTelemetryReporterStub) NewExecutor(db.Task, db.Template, db.Inventory, db.Repository, db.Environment, string, string, []db.HostConfig) (tasks.Executor, error) {
...
func (p *dockerPolicyConsumerStub) NewExecutor(db.Task, db.Template, db.Inventory, db.Repository, db.Environment, string, string, []db.HostConfig) (tasks.Executor, error) {
	return nil, nil
}
...
func (p *denyingDockerPolicyProvider) NewExecutor(db.Task, db.Template, db.Inventory, db.Repository, db.Environment, string, string, []db.HostConfig) (tasks.Executor, error) {
