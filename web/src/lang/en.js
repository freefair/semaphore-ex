export default {
  ...
  hostConfigEmpty: 'No mappings yet. Add one to use a different credential for a '
    + 'specific Git host or repository URL, for example for submodules or role '
    + 'dependencies hosted somewhere else.',
  hostConfigHostOrUrl: 'Host or URL',
  hostConfigTypeHost: 'Host',
  hostConfigTypeUrl: 'URL',
  hostConfigHost: 'Host',
  hostConfigUrl: 'URL',
  ...
  hostConfigCredentialHostHint: 'A host mapping needs an SSH key',
  hostConfigCredentialUrlHint: 'An SSH key, or a login/password to authenticate over HTTPS',
  credential: 'Credential',
  addMapping: 'Add mapping',
  editMapping: 'Edit mapping',
  deleteMapping: 'Delete mapping',
  askDeleteMapping: 'Do you really want to delete this mapping?',
  darkMode: 'Dark Mode',
  team: 'Team',
  more: 'More',
  pin: 'Pin to sidebar',
