...
func TestWorkflowFileArtifactRoutesReuseWorkflowRunHierarchy(t *testing.T) {
	...
	base := "/api/project/{project_id}/workflows/{workflow_id}/runs/{run_id}/file-artifacts"
	for _, suffix := range []string{"", "/{artifact_id}", "/{artifact_id}/content", "/{artifact_id}/finalize"} {
