...
func TestGlobalCredentialRoutesEnforceSeparatedPermissions(t *testing.T) {
	...
	router := rootapi.Route(store, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, globalCredentialPermissionLogWriter{}, nil, metrics.NewMetrics(), nil)
